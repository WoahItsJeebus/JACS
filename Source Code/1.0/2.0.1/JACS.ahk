...
ShowPatchNotesGUI(*) {
	...
	TopLabel.GetPos(,,&LabelWidth,&LabelHeight)

	patches := PatchUI.Add("Edit", "vPatchnotes VScroll Section ReadOnly h" Popout_Height-LabelHeight " w" Popout_Width-PatchUI.MarginX, patchNotes)
