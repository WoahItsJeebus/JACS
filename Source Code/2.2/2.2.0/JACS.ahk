...
GetUpdate(*) {
    ...
    if (latestVersion = "")
        return MsgBox("Failed to retrieve update information.", "Error")
...
ShowPatchNotesGUI(release := "latest") {
	...
	local VersionList := PatchUI.Add("DropDownList", "xm Section Center vVersionList R3 h40 w" (Popout_Width-PatchUI.MarginX)/2.5, ["latest"])
	VersionList.SetFont("", "Consolas")
	...
	BodyBox.SetFont("s12 w600", "Consolas")
